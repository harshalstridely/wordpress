...
if(get_post_meta($qode_page_id, "qode_enable_content_bottom_area", true) != ""){
	...
	if (isset($strata_options['enable_content_bottom_area'])) { 
		$content_bottom_area = $strata_options['enable_content_bottom_area'];
	}
}
...
if(get_post_meta($qode_page_id, 'qode_choose_content_bottom_sidebar', true) != ""){
	...
	if(isset($strata_options['content_bottom_sidebar_custom_display'])) {
		$content_bottom_area_sidebar = $strata_options['content_bottom_sidebar_custom_display'];
	}
}
...
if(get_post_meta($qode_page_id, 'qode_content_bottom_sidebar_in_grid', true) != ""){
	...
	if(isset($strata_options['content_bottom_in_grid'])){if ($strata_options['content_bottom_in_grid'] == "no") $content_bottom_area_in_grid = false;}
}
...
if(isset($strata_options['uncovering_footer'])){if ($strata_options['uncovering_footer'] == "no") $uncovering_footer = false;}
?>
	<footer <?php if($uncovering_footer){echo 'class="uncover"';} ?>>
		<div class="footer_inner clearfix">
		<?php
		$footer_in_grid = true;
		if(isset($strata_options['footer_in_grid'])){
			if ($strata_options['footer_in_grid'] != "yes") {
				$footer_in_grid = false;
			}
		}
		
		$display_footer_top = true;
		if ( isset( $strata_options['show_footer_top'] ) && $strata_options['show_footer_top'] == "no" ) {
		...
		if (isset($strata_options['footer_top_columns'])) {
			$footer_top_columns = $strata_options['footer_top_columns'];
		}
		
		if ( $display_footer_top && $footer_top_flag ) { ?>
		...
		if ( isset( $strata_options['footer_text'] ) ) {
			if ( $strata_options['footer_text'] == "yes" ) {
				$display_footer_text = true;
			}
		}
		if ( $display_footer_text && is_active_sidebar( 'footer_text' ) ): ?>
