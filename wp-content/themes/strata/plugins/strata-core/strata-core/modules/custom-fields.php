							...
							switch ( $customField[ 'type' ] ) {
								...
								case "selectbox": {
									...
									?>
										...
										<option value="default" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "default" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'No Sidebar', 'strata-core' ); ?></option>
										<option value="1" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "1" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Sidebar 1/3 right', 'strata-core' ); ?></option>
										<option value="2" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "2" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Sidebar 1/4 right', 'strata-core' ); ?></option>
										<option value="3" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "3" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Sidebar 1/3 left', 'strata-core' ); ?></option>
										<option value="4" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "4" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Sidebar 1/4 left', 'strata-core' ); ?></option>
								...
								case "selectbox-featured-image": {
									...
									echo '<select name="' . $this->prefix . $customField[ 'name' ] . '" id="' . $this->prefix . $customField[ 'name' ] . '"> ';
									?>
										<option value="no" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "no" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'No', 'strata-core' ); ?></option>
										<option value="yes" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "yes" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Yes', 'strata-core' ); ?></option>
								...
								case "selectbox-portfolio-single": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="1" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "1" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Portfolio small images', 'strata-core' ); ?></option>
										<option value="2" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "2" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Portfolio small slider', 'strata-core' ); ?></option>
										<option value="5" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "5" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Portfolio big images', 'strata-core' ); ?></option>
										<option value="3" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "3" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Portfolio big slider', 'strata-core' ); ?></option>
										<option value="4" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "4" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Portfolio custom', 'strata-core' ); ?></option>
										<option value="7" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "7" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Portfolio full width custom', 'strata-core' ); ?></option>
										<option value="6" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "6" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Portfolio gallery', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
								...
								case "selectbox-portfolio-columns-number": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="2" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "2" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '2 Columns', 'strata-core' ); ?></option>
										<option value="3" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "3" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '3 Columns', 'strata-core' ); ?></option>
										<option value="4" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "4" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '4 Columns', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
								...
								case "selectbox-animation": {
									...
									?>
										...
										<option value="no_animation" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "no_animation" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'No animation', 'strata-core' ); ?></option>
										<option value="updown" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "updown" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Up / Down', 'strata-core' ); ?></option>
										<option value="fade" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "fade" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Fade', 'strata-core' ); ?></option>
										<option value="updown_fade" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "updown_fade" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Up/Down (In) / Fade (Out)', 'strata-core' ); ?></option>
										<option value="leftright" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "leftright" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Left / Right', 'strata-core' ); ?></option>
										<?php 
										echo '</select>';
										echo '</div>';
									}
								...
								case "selectbox-title-animation": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="no" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "no" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'No animation', 'strata-core' ); ?></option>
										<option value="text_right_left" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "text_right_left" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Text right to left', 'strata-core' ); ?></option>
										<option value="area_top_bottom" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "area_top_bottom" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Title area top to bottom', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
								...
								case "selectbox-fixed-title-image": {
									...
									?>
										...
										<option value="no" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "no" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'No', 'strata-core' ); ?></option>
										<option value="yes" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "yes" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Yes', 'strata-core' ); ?></option>
										<option value="yes_zoom" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "yes_zoom" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Yes, with zoom out', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
								...
								case "selectbox-header-style": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="light" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "light" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Light', 'strata-core' ); ?></option>
										<option value="dark" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "dark" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Dark', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
								...
								case "slide-background-type": {
									...
									echo '<div class="form-field '. $float_left .' form-required">';
									echo '<label for="' . $this->prefix . $customField[ 'name' ] .'" style="display:inline;"><b>' . $customField[ 'title' ] . '</b></label>&nbsp;&nbsp;&nbsp;&nbsp;';
									echo '<label for="image_background" style="display:inline;"><b>' . esc_html__( 'Image', 'strata-core' ) . '</b></label>&nbsp;';
									...
									if ( get_post_meta( $post->ID, $this->prefix . $customField['name'], true ) == "image" )
										echo ' checked="checked"';
									echo '" style="width: auto;" />';
									echo '<label for="video_background" style="display:inline;"><b>' . esc_attr__( 'Video', 'strata-core' ) . '</b></label>&nbsp;';
								...
								case "selectbox-thumbnail-animation": {
									...
									echo '<select name="' . $this->prefix . $customField[ 'name' ] . '" id="' . $this->prefix . $customField[ 'name' ] . '"> ';
									?>
										<option value="flip" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "flip" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Flip', 'strata-core' ); ?></option>
										<option value="fade" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "fade" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Fade', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
								...
								case "font-family": {
									...
									echo '<select name="' . $this->prefix . $customField[ 'name' ] . '" id="' . $this->prefix . $customField[ 'name' ] . '"> ';
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "-1" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Default', 'strata-core' ); ?></option>
										<?php foreach($fontArrays as $fontArray) { ?>
											<option <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == str_replace(' ', '+', $fontArray["family"])) { echo "selected='selected'"; } ?>  value="<?php echo str_replace(' ', '+', $fontArray["family"]); ?>"><?php echo esc_attr( $fontArray["family"] ); ?></option>
										<?php } ?>
									<?php 
									echo '</select>';
									echo '</div>';
								...
								case "font-style": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="normal" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "normal" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Normal', 'strata-core' ); ?></option>
										<option value="italic" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "italic" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Italic', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
								...
								case "font-weight": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="200" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "200" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '200', 'strata-core' ); ?></option>
										<option value="300" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "300" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '300', 'strata-core' ); ?></option>
										<option value="400" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "400" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '400', 'strata-core' ); ?></option>
										<option value="600" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "600" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '600', 'strata-core' ); ?></option>
										<option value="800" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "800" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( '800', 'strata-core' ); ?></option>
								...
								case "selectbox-content-alignment": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="left" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "left" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Left', 'strata-core' ); ?></option>
										<option value="center" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "center" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Center', 'strata-core' ); ?></option>
										<option value="right" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "right" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Right', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
								...
								case "selectbox-carousel-item-target": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="_self" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "_self" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Self', 'strata-core' ); ?></option>
										<option value="_blank" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "_blank" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Blank', 'strata-core' ); ?></option>
										<option value="_parent" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "_parent" ) { ?> selected="selected" <?php } ?>><?php esc_html_e( 'Parent', 'strata-core' ); ?></option>
									<?php 
									echo '</select>';
									echo '</div>';
									break;
		...
		*/
		function displayCustomSeo() {
			...
			<div class="input form-field">
					...
					?>
				<label for="seo_title"><b><?php esc_html_e( 'SEO Title', 'strata-core' ); ?></b></label>
				<input id="seo_title" class="seo_title" type="text" value="<?php echo esc_attr($seo_title); ?>" name="seo_title">
			</div>
			<div class="input form-field">
					<?php
					$seo_keywords = get_post_meta( $post->ID, $this->prefix . 'seo_keywords', true );
					?>
				<label for="seo_keywords"><b><?php esc_html_e( 'SEO Keywords', 'strata-core' ); ?></b></label>
				<input id="seo_keywords" class="seo_keywords" type="text" value="<?php echo esc_attr($seo_keywords); ?>" name="seo_keywords">
			</div>		
			<div class="input form-field">
					<?php
					$seo_description = get_post_meta( $post->ID, $this->prefix . 'seo_description', true );
					?>
				<label for="seo_description"><b><?php esc_html_e( 'SEO Description', 'strata-core' ); ?></b></label>
				<textarea id="seo_description" class="seo_description" name="seo_description"><?php echo esc_html($seo_description); ?></textarea>
			</div>		
		...
		function displayCustomPortfolio() {
			...
			<div class="form-wrap">
					<div class="hidden_portfolio_images">
						<div class="input form-field">
							<label><b><?php esc_html_e( 'Order number', 'strata-core' ); ?></b></label>
							<input class="ordernumber" type="text" id="portfolioimgordernumber_x" name="portfolioimgordernumber_x" size="10" />
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Image/Video title (only for gallery layout - Portfolio Style 6)', 'strata-core' ); ?></b></label>
							<input type="text" name="portfoliotitle_x" id="portfoliotitle_x" class="portfoliotitle" />
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Image', 'strata-core' ); ?></b></label>
						...
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Video type', 'strata-core' ); ?></b></label>
							<select name="portfoliovideotype_x" id="portfoliovideotype_x" class="portfoliovideotype">  
								<option value=""></option>
								<option value="youtube"><?php esc_html_e( 'Youtube', 'strata-core' ); ?></option>
								<option value="vimeo"><?php esc_html_e( 'Vimeo', 'strata-core' ); ?></option>
								<option value="self"><?php esc_html_e( 'Self hosted', 'strata-core' ); ?></option>
							</select>
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Video ID', 'strata-core' ); ?></b></label>
							<input type="text" name="portfoliovideoid_x" id="portfoliovideoid_x" class="portfoliovideoid" />
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Video image', 'strata-core' ); ?></b></label>
							<input type="text" id="portfoliovideoimage_x" name="portfoliovideoimage_x" class="portfolio_self_video portfolioimg" />
							<input class="upload_button" type="button" value="Upload file">
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Video webm', 'strata-core' ); ?></b></label>
							<input type="text" name="portfoliovideowebm_x" id="portfoliovideowebm_x" class="portfolio_self_video" />
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Video mp4', 'strata-core' ); ?></b></label>
							<input type="text" name="portfoliovideomp4_x" id="portfoliovideomp4_x" class="portfolio_self_video" />
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Video ogv', 'strata-core' ); ?></b></label>
					...
					<div class="hidden_portfolio">
						...
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Option Label', 'strata-core' ); ?></b></label>
							<input type="text" id="optionLabel_x" name="optionLabel_x" />
						</div>
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Option Value', 'strata-core' ); ?></b></label>
							<textarea rows="8" cols="40" id="optionValue_x" name="optionValue_x"></textarea>
						</div>						
						<div class="input form-field">
							<label for=""><b><?php esc_html_e( 'Option Url', 'strata-core' ); ?></b></label>
...
<h3><?php esc_html_e( 'Portfolio images/videos', 'strata-core' ); ?></h3>
...
<div class="portfolio_image" rel="<?php echo esc_attr($no); ?>" style="display: block;">
<div class="input form-field">
<label for="portfolioimgordernumber_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Order number', 'strata-core' ); ?></b></label>
<input id="portfolioimgordernumber_<?php echo esc_attr($no); ?>" type="text" name="portfolioimgordernumber[]" value="<?php echo isset($portfolio_image['portfolioimgordernumber'])?stripslashes($portfolio_image['portfolioimgordernumber']):""; ?>" class="ordernumber" />
</div>
<div class="input form-field">
<label for="portfoliotitle_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Image/Video title (only for gallery layout - Portfolio Style 6)', 'strata-core' ); ?></b></label>
<input id="portfoliotitle_<?php echo esc_attr($no); ?>" type="text" name="portfoliotitle[]" value="<?php echo isset($portfolio_image['portfoliotitle'])?stripslashes($portfolio_image['portfoliotitle']):""; ?>" class="portfoliotitle" />
</div>
<div class="input form-field">
<label for="portfolioimg_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Image', 'strata-core' ); ?></b></label>
<input id="portfolioimg_<?php echo esc_attr($no); ?>" type="text" name="portfolioimg[]" value="<?php echo stripslashes($portfolio_image['portfolioimg']); ?>" class="portfolioimg" />
<input class="upload_button" type="button" value="Upload file">
</div>
<div class="input form-field">
	<label for="portfoliovideotype_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Video type', 'strata-core' ); ?></b></label>
	<select name="portfoliovideotype[]" id="portfoliovideotype_<?php echo esc_attr($no); ?>" class="portfoliovideotype">
		<option value=""></option>
		<option <?php if(isset($portfolio_image['portfoliovideotype'])){ if($portfolio_image['portfoliovideotype'] == "youtube") echo "selected='selected'"; } ?> value="youtube"><?php esc_html_e( 'Youtube', 'strata-core' ); ?></option>
		<option <?php if(isset($portfolio_image['portfoliovideotype'])){ if($portfolio_image['portfoliovideotype'] == "vimeo") echo "selected='selected'"; } ?> value="vimeo"><?php esc_html_e( 'Vimeo', 'strata-core' ); ?></option>
		<option <?php if(isset($portfolio_image['portfoliovideotype'])){ if($portfolio_image['portfoliovideotype'] == "self") echo "selected='selected'"; } ?> value="self"><?php esc_html_e( 'Self hosted', 'strata-core' ); ?></option>
	</select>
</div>
<div class="input form-field">
<label for="portfoliovideoid_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Video ID', 'strata-core' ); ?></b></label>
<input id="portfoliovideoid_<?php echo esc_attr($no); ?>" type="text" name="portfoliovideoid[]" value="<?php echo isset($portfolio_image['portfoliovideoid'])?stripslashes($portfolio_image['portfoliovideoid']):""; ?>" class="portfoliovideoid" />
</div>
<div class="input form-field">
	<label for="portfoliovideoimage_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Video image', 'strata-core' ); ?></b></label>
	<input type="text" id="portfoliovideoimage_<?php echo esc_attr($no); ?>" name="portfoliovideoimage[]" value="<?php echo isset($portfolio_image['portfoliovideoimage'])?stripslashes($portfolio_image['portfoliovideoimage']):""; ?>" class="portfolio_self_video portfolioimg" />
	<input class="upload_button" type="button" value="Upload file">
</div>
<div class="input form-field">
	<label for="portfoliovideowebm_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Video webm', 'strata-core' ); ?></b></label>
	<input type="text" id="portfoliovideowebm_<?php echo esc_attr($no); ?>" name="portfoliovideowebm[]" value="<?php echo isset($portfolio_image['portfoliovideowebm'])?stripslashes($portfolio_image['portfoliovideowebm']):""; ?>" class="portfolio_self_video" />
</div>
<div class="input form-field">
	<label for="portfoliovideomp4_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Video mp4', 'strata-core' ); ?></b></label>
	<input type="text" id="portfoliovideomp4_<?php echo esc_attr($no); ?>" name="portfoliovideomp4[]" value="<?php echo isset($portfolio_image['portfoliovideomp4'])?stripslashes($portfolio_image['portfoliovideomp4']):""; ?>" class="portfolio_self_video" />
</div>
<div class="input form-field">
	<label for="portfoliovideoogv_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Video ogv', 'strata-core' ); ?></b></label>
	<input type="text" id="portfoliovideoogv_<?php echo esc_attr($no); ?>" name="portfoliovideoogv[]" value="<?php echo isset($portfolio_image['portfoliovideoogv'])?stripslashes($portfolio_image['portfoliovideoogv']):""; ?>" class="portfolio_self_video" />
</div>
<a class="remove_image" href="/" onclick="javascript: return false;"><?php esc_html_e( 'Remove portfolio image/video', 'strata-core' ); ?></a>
</div>
...
?>
				<a class="add_image" onclick="javascript: return false;" href="/" ><?php esc_html_e( 'Add portfolio image/video', 'strata-core' ); ?></a>
</div>
</div>
					
<div class="add_portfolios">
<h3><?php esc_html_e( 'Option Items', 'strata-core' ); ?></h3>
...
<div class="portfolio" rel="<?php echo esc_attr($no); ?>" style="display: block;">
<div class="input form-field">
<label for="optionlabelordernumber_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Order number', 'strata-core' ); ?></b></label>
<input id="optionlabelordernumber_<?php echo esc_attr($no); ?>" type="text" name="optionlabelordernumber[]" value="<?php echo isset($portfolio['optionlabelordernumber'])?stripslashes($portfolio['optionlabelordernumber']):""; ?>" class="ordernumber" />
</div>
<div class="input form-field">
<label for="optionLabel_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Option Label', 'strata-core' ); ?></b></label>
<input id="optionLabel_<?php echo esc_attr($no); ?>" type="text" name="optionLabel[]" value="<?php echo stripslashes($portfolio['optionLabel']); ?>">
</div>
<div class="input form-field">
<label for="optionValue_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Option Value', 'strata-core' ); ?></b></label>
<textarea id="optionValue_<?php echo esc_attr($no); ?>" name="optionValue[]" cols="40" rows="8"><?php echo stripslashes($portfolio['optionValue']); ?></textarea>
</div>
<div class="input form-field">
<label for="optionUrl_<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Option Url', 'strata-core' ); ?></b></label>
<input id="optionUrl_<?php echo esc_attr($no); ?>" type="text" name="optionUrl[]" value="<?php echo stripslashes($portfolio['optionUrl']); ?>">
</div>

<a class="remove_option" href="/" onclick="javascript: return false;"><?php esc_html_e( 'Remove portfolio option', 'strata-core' ); ?></a>
</div>
...
?>
				<a class="add_option" onclick="javascript: return false;" href="/" ><?php esc_html_e( 'Add portfolio option', 'strata-core' ); ?></a>
</div>
</div>
			<div class="input form-field">
<?php
...
?>
				<label for="portfolio_date<?php echo esc_attr($no); ?>"><b><?php esc_html_e( 'Portfolio Date', 'strata-core' ); ?></b></label>
				<input id="portfolio_date" class="datepicker" type="text" value="<?php echo esc_attr($portfolio_date); ?>" name="portfolio_date">
			</div>
		</div>
			<?php
		}
