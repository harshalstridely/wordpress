...
if ( ! function_exists( 'strata_qode_add_custom_nav_fields' ) ) {
	function strata_qode_add_custom_nav_fields( $menu_item ) {
	...
	add_filter( 'wp_setup_nav_menu_item', 'strata_qode_add_custom_nav_fields' );
}

if ( ! function_exists( 'strata_qode_update_custom_nav_fields' ) ) {
	/**
	 ...
	 * @return      void
	 */
	function strata_qode_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
	...
	// save menu custom fields
	add_action( 'wp_update_nav_menu_item', 'strata_qode_update_custom_nav_fields', 10, 3 );
}

if ( ! function_exists( 'strata_qode_edit_walker' ) ) {
	/**
	 ...
	 * @return      void
	 */
	function strata_qode_edit_walker( $walker, $menu_id ) {
		return 'Walker_Nav_Menu_Edit_Custom';
	}
	
	// edit menu walker
	add_filter( 'wp_edit_nav_menu_walker', 'strata_qode_edit_walker', 10, 2 );
}

include_once QODE_INCLUDES_ROOT_DIR . '/nav-menu/qode-edit-custom-walker.php';

/* Custom WP_NAV_MENU function for top navigation */

if ( ! class_exists( 'strata_qode_type1_walker_nav_menu' ) ) {
	class strata_qode_type1_walker_nav_menu extends Walker_Nav_Menu {
...
if ( ! class_exists( 'strata_qode_type2_walker_nav_menu' ) ) {
	class strata_qode_type2_walker_nav_menu extends Walker_Nav_Menu {
