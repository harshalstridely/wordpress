...
class Call_To_Action extends WP_Widget {
    public function __construct() {
		parent::__construct(
			...
			esc_html__( 'Strata Call To Action', 'strata' ), // Name
			array( 'description' => esc_html__( 'Display a Call to Action element', 'strata' ), ) // Args
		);
	}
    ...
    public function widget($args, $instance) {
        ...
        $button_text    = (isset($instance['button_text']) && $instance['button_text'] != "") ? $instance['button_text'] : esc_html__('Default button text', 'strata');
        $text           = (isset($instance['text']) && $instance['text'] != "") ? $instance['text'] :  esc_html__('Default call to action text', 'strata');
 	...
 	public function form($instance) {
		...
		?>
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php esc_html_e( 'Text:','strata'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php esc_html_e( 'Text Color:','strata' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'text_size' )); ?>"><?php esc_html_e( 'Text Size:','strata' ); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'background_color' )); ?>"><?php esc_html_e( 'Background Color:','strata' ); ?></label>
        ...
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'padding_bottom' )); ?>"><?php esc_html_e( 'Padding Bottom:','strata' ); ?></label>
        ...
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'padding_top' )); ?>"><?php esc_html_e( 'Padding Top:','strata' ); ?></label>
        ...
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_option' )); ?>"><?php esc_html_e( 'Show Button:','strata' ); ?></label>
		<select id="<?php echo esc_attr($this->get_field_id( 'button_option' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_option' )); ?>">
            <option value="yes" <?php if(esc_attr($button_option) == "yes"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Yes', 'strata' ); ?></option>  
            <option value="no" <?php if(esc_attr($button_option) == "no"){echo 'selected="selected"';} ?>><?php esc_html_e( 'No', 'strata' ); ?></option>  
		</select>
        </p>
        ...
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_text' )); ?>"><?php esc_html_e( 'Button Text:','strata' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'button_text' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_text' )); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
		</p>
        
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_color' )); ?>"><?php esc_html_e( 'Button Color:','strata' ); ?></label>
        ...
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_top_gradient_background_color' )); ?>"><?php esc_html_e( 'Button Top Gradient Background Color:','strata' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'button_top_gradient_background_color' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_top_gradient_background_color' )); ?>" type="text" value="<?php echo esc_attr( $button_top_gradient_background_color ); ?>" />
		</p>

        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_bottom_gradient_background_color' )); ?>"><?php esc_html_e( 'Button Bottom Gradient Background Color:','strata' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'button_bottom_gradient_background_color' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_bottom_gradient_background_color' )); ?>" type="text" value="<?php echo esc_attr( $button_bottom_gradient_background_color ); ?>" />
		</p>

        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_border_color' )); ?>"><?php esc_html_e( 'Button Border Color:','strata' ); ?></label>
        ...
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_link' )); ?>"><?php esc_html_e( 'Button Link:','strata' ); ?></label>
        ...
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_target' )); ?>"><?php esc_html_e( 'Button Target:','strata' ); ?></label>
		<select id="<?php echo esc_attr($this->get_field_id( 'button_target' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_target' )); ?>">
            <option value="_blank" <?php if(esc_attr($button_target) == "_blank"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Blank', 'strata' ); ?></option>  
            <option value="_self" <?php if(esc_attr($button_target) == "_self"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Self', 'strata' ); ?></option>  
            <option value="_top" <?php if(esc_attr($button_target) == "_top"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Top', 'strata' ); ?></option>  
            <option value="_parent" <?php if(esc_attr($button_target) == "_parent"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Parent', 'strata' ); ?></option>  
		</select>
        </p>
        
        <p>
		<label for="<?php echo esc_attr($this->get_field_id( 'button_position' )); ?>"><?php esc_html_e( 'Button Position:','strata' ); ?></label>
		<select id="<?php echo esc_attr($this->get_field_id( 'button_position' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_position' )); ?>">
            <option value="right" <?php if(esc_attr($button_position) == "right"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Right', 'strata' ); ?></option>  
            <option value="left" <?php if(esc_attr($button_position) == "left"){echo 'selected="selected"';} ?>><?php esc_html_e( 'Left', 'strata' ); ?></option>  
		</select>
        </p>
