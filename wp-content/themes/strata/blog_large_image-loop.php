...
?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post_content_holder">
				...
				<div class="post_text">
					<h2 class="post_title_label"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
					...
					<?php
					$link_page_exists = strata_qode_wp_link_pages_exist();
						...
						if ( ! post_password_required() ) { ?>
							<div class="post_info">
								<div class="post_info_left">
									<a href="<?php the_permalink(); ?>" class="qbutton small dark"><?php esc_html_e('Read More','strata'); ?></a>
								</div>
							</div>
						<?php }
					} else {
						strata_qode_wp_link_pages();
					}
					?>
				</div>
			</div>
