...
$j(document).ready(function() {
	...
	$j('ul#tootlbar_header_color li').on( 'click', function(e){
		e.preventDefault();
	...
	$j('ul#tootlbar_footer_type li').on( 'click', function(e){
		e.preventDefault();
	...
	$j("#panel.default a.open").on( 'click', function(e){
		e.preventDefault();
	...
	$j('ul#tootlbar_header_top_menu li').on( 'click', function(){
	...
	$j('ul#tootlbar_smooth_scroll li').on( 'click', function(){
		if($j(this).attr("data-value") !== ""){
	...
	$j('ul#tootlbar_header_type li').on( 'click', function(){
		if($j(this).attr("data-value") !== ""){
	...
	$j('ul#tootlbar_pattern li').on( 'click', function(){
	...
	$j('ul#tootlbar_background li').on( 'click', function(){
	...
	$j('ul#tootlbar_boxed li').on( 'click', function(){
	...
	$j('ul#tootlbar_tooltips li').on( 'click', function(){
