				...
				<div class="post_text">
					<div class="post_text_holder">
						...
						<div class="post_title">
							...
							<h3><a href="<?php echo esc_url($title_link); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3>
						</div>
					</div>
					<?php the_content(); ?>
				</div>
...
?>
	<?php if( has_tag()) { ?>
		<div class="single_tags clearfix">
            <div class="tags_text"><i class="fa fa-tag"></i> <h5><?php esc_html_e( 'Tags:', 'strata' ); ?></h5></div>
			<?php the_tags('', '', ''); ?>
		</div>
	<?php } ?>				
	<?php 
	...
	?>
<?php if(strata_qode_is_author_info_enabled() && get_the_author_meta('description') != "" ) { ?>
